Shader "Custom/UI/MetallicReflection (Metallic Map)" {
    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag (v2f IN) : SV_Target {
                ...
                half metal = tex2D(_MetallicMap, IN.texcoord).r;
                half4 environment = texCUBE(_EnvironmentMap, worldReflection);
                color *= metal * environment;
