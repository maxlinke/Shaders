Shader "Custom/Terrain/Old/Steepness Visualization (Dot)" {
	...
	SubShader {
		...
		void vert(inout appdata_full v, out Input o){
			...
			float steepness = dot(normalize(_Direction.xyz), normalize(o.worldNormal));
			o.steepCoord = 1.0 - ((steepness + 1.0) / 2.0);
		}
